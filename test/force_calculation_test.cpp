...
// result should be same about x and y axis
TEST(ForceCalculationTest, force_should_be_same_about_x_and_y_axis) {
    ...
    EdgeNode edge_node2(Eigen::Vector3f(0, 1, 1),
                       Eigen::Vector2f(1, 0),
                       0);
...
TEST(ForceCalculationTest, force_should_be_zero_if_translation_direction_is_same_as_edge_direction_about_y_axis) {
    ...
    EdgeNode edge_node(Eigen::Vector3f(1, 0, 1),
                       Eigen::Vector2f(0, 1),
                       0);
...
// with horizontal edge, torque should be zero
TEST(ForceCalculationTest, torque_calculation_with_horizontal_edge_test2) {
    ...
    EdgeNode edge_node1(Eigen::Vector3f(0, 1, 1),
                       Eigen::Vector2f(1, 0),
                       0);
